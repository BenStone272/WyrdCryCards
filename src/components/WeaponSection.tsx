        ...
        {weapons.length === 0 ? (
          ...
          weapons.map((weapon, idx) => (
            <li key={`${fighterId}-weapon-${idx}`} className="weapon-showcase-row">
              <div className="weapon-showcase-grid">
                <div className="weapon-cell weapon-cell-type">
                  ...
                  />
                  <span className="weapon-type-label">{weapon.name?.trim() || formatRunemarkLabel(weapon.runemark)}</span>
                </div>
              ...
              {weapon.special?.trim() && <p className="weapon-special-text">{weapon.special.trim()}</p>}
            </li>
          ))
        )}
      </ul>
